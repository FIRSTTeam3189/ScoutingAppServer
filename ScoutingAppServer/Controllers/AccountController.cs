...
using ScoutingServer.Interfaces;
...
namespace ScoutingServer.Controllers {
    ...
    public class AccountController : ApiController {
        ...
        public HttpResponseMessage CustomRegister(CustomRegistrationRequest request) {
            System.Diagnostics.Trace.TraceError("testasdfasdf");
        ...
        public async Task<HttpResponseMessage> Register(RegistrationRequest request) {
            ...
            if(error != null) {
                ...
                if(GodDamnFuckingId != null) {
                    ...
                    return Request.CreateResponse(HttpStatusCode.BadRequest, "fuck you, you stupid cunt");
                }
            }
        }
    ...
    public static class IListAccountInfoExtention {
        public static List<ClientAccount> GetClientList(this IList<Account> me, MobileServiceContext context) {
